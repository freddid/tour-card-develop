...
var DateRange = function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function setSelection(value, isSingleValue) {
      ...
      if (typeof this.props.shouldKeepPreview === 'function' && !this.props.shouldKeepPreview(newSelection)) {
        return;
      }
    ...
    value: function updatePreview(val) {
      ...
      if (typeof this.props.shouldKeepPreview === 'function' && !this.props.shouldKeepPreview(val)) {
        return;
      }
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          mobileMode = _props4.mobileMode,
          dayCellsOptions = _props4.dayCellsOptions,
          className = _props4.className;
      var _state = this.state,
          focusedRange = _state.focusedRange,
      ...
      return _react2.default.createElement(_Calendar2.default, _extends({
        ...
        preview: preview,
        touchSelectionEnabled: mobileMode,
        ...
        className: (0, _classnames2.default)(this.styles.dateRangeWrapper, className),
...
DateRange.propTypes = _extends({}, _Calendar2.default.propTypes, {
  ...
  shouldKeepPreview: _propTypes2.default.func,
