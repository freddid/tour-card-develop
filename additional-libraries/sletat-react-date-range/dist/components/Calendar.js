...
var Calendar = function (_PureComponent) {
  ...
  function Calendar(props, context) {
    ...
    _this.onTouchSelectionStart = _this.onTouchSelectionStart.bind(_this);
    _this.onTouchSelectionEnd = _this.onTouchSelectionEnd.bind(_this);
  ...
  _createClass(Calendar, [{
    ...
    value: function onDragSelectionStart(date) {
      var _props4 = this.props,
          ...
          touchSelectionEnabled = _props4.touchSelectionEnabled;

      if (touchSelectionEnabled) {
        this.onTouchSelectionStart(date);
        return;
      }
    ...
    value: function onDragSelectionEnd(date) {
      var _props5 = this.props,
          ...
          touchSelectionEnabled = _props5.touchSelectionEnabled;


      if (!dragSelectionEnabled) return;

      if (touchSelectionEnabled) {
        this.onTouchSelectionEnd(date);
        return;
      }
    ...
    value: function onDragSelectionMove(date) {
      ...
      if (!drag.status || !this.props.dragSelectionEnabled || this.props.touchSelectionEnabled) {
        return;
      }
      this.setState({
        drag: {
    ...
    key: 'onTouchSelectionStart',
    value: function onTouchSelectionStart(date) {
      var onChange = this.props.onChange;

      if (this.props.touchSelectionEnabled) {
        this.setState({
          touch: {
            status: true,
            range: { startDate: date, endDate: date },
    ...
    key: 'onTouchSelectionEnd',
    value: function onTouchSelectionEnd(date) {
      var _props6 = this.props,
          updateRange = _props6.updateRange,
          onChange = _props6.onChange,
          displayMode = _props6.displayMode;

      if (!this.props.touchSelectionEnabled) return;

      var newRange = {
        startDate: this.state.touch.range.startDate,
        endDate: date
      };

      if (displayMode !== 'dateRange' || (0, _isSameDay2.default)(newRange.startDate, date)) {
        this.setState({ touch: { status: false, range: {}, disablePreview: true } }, function () {
          return onChange && onChange(date);
        });
      } else {
        this.setState({ touch: { status: false, range: {}, disablePreview: true } }, function () {
    ...
    value: function render() {
      ...
      var _props8 = this.props,
          ...
          color = _props8.color,
          dayCellsOptions = _props8.dayCellsOptions;
            ...
            _react2.default.createElement(_reactList2.default, {
              ...
              itemRenderer: function itemRenderer(index, key) {
                ...
                return _react2.default.createElement(_Month2.default, _extends({}, _this5.props, {
                  ...
                  touch: _this5.props.touchSelectionEnabled ? _this5.state.touch : null,
                  dateOptions: _this5.dateOptions,
                  disabledDates: disabledDates,
                  dayCellsOptions: dayCellsOptions,
                  month: monthStep,
                  ...
                  onTouchSelectionStart: _this5.onTouchSelectionStart,
                  onTouchSelectionEnd: _this5.onTouchSelectionEnd,
                  onMouseLeave: function onMouseLeave() {
                    return onPreviewChange && onPreviewChange();
                  },
...
Calendar.propTypes = {
  ...
  dayCellsOptions: _propTypes2.default.arrayOf(_DayCell.dayCellOptionsShape),
  ...
  touchSelectionEnabled: _propTypes2.default.bool
};
