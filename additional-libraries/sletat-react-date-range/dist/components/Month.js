  ...
  _createClass(Month, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          _props$dayCellsOption = _props.dayCellsOptions,
          dayCellsOptions = _props$dayCellsOption === undefined ? [] : _props$dayCellsOption;
      ...
      var showPreview = touch ? !touch.disablePreview : this.props.showPreview && !drag.disablePreview;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            onTouchEnd: this.props.onTouchLeave },
          (0, _eachDayOfInterval2.default)({ start: monthDisplay.start, end: monthDisplay.end }).map(function (day, index) {
            ...
            var options = dayCellsOptions.find(function (dayOptions) {
              return (0, _isSameDay2.default)(day, dayOptions.date);
            });
            ...
            return _react2.default.createElement(_DayCell2.default, _extends({}, _this2.props, {
              ...
              // onTouchStart={day => this.props.onTouchSelectionStart(day)}
              // onTouchEnd={day => this.props.onTouchSelectionEnd(day)}
...
Month.propTypes = {
  ...
  touch: _propTypes2.default.object,
  ...
  onTouchSelectionStart: _propTypes2.default.func,
  onTouchSelectionEnd: _propTypes2.default.func,
  onMouseLeave: _propTypes2.default.func,
  onTouchLeave: _propTypes2.default.func,
