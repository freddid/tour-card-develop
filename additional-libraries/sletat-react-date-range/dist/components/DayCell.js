...
exports.dayCellOptionsShape = exports.rangeShape = undefined;
...
var DayCell = function (_Component) {
  ...
  function DayCell(props, context) {
    ...
    // SLT-3261 пока не работает в shadow dom
  ...
  _createClass(DayCell, [{
    ...
    //   switch (event.type) {
    //     case 'touchstart':
    //       this.props.onTouchStart(day);
    //       break;
    //     case 'touchend':
    //       stateChanges.hover = false;
    //       stateChanges.active = false;
    //       this.props.onTouchEnd(day);
    //       break;
    //   }
    //   if (Object.keys(stateChanges).length) {
    //     this.setState(stateChanges);
    ...
    value: function renderDayContent() {
      var _props5 = this.props,
          customContent = _props5.options.customContent,
          isToday = _props5.isToday;


      return customContent && !isToday ? customContent((0, _format2.default)(this.props.day, 'D')) : _react2.default.createElement(
        'span',
        null,
...
var dayCellOptionsShape = exports.dayCellOptionsShape = _propTypes2.default.shape({
  date: _propTypes2.default.object,
  customContent: _propTypes2.default.func
});
...
DayCell.propTypes = {
  ...
  isAvailibleDate: _propTypes2.default.bool,
  color: _propTypes2.default.string,
