...
var _isArguments = __webpack_require__(56);
...
var _dissoc2 = __webpack_require__(43);

var _dissoc3 = _interopRequireDefault(_dissoc2);

var _groupBy2 = __webpack_require__(46);

var _groupBy3 = _interopRequireDefault(_groupBy2);

var _memoize2 = __webpack_require__(68);
...
var withContext = exports.withContext = function withContext(contextTypes) {
  ...
  return _temp3 = _class2 = function (_Component) {
    ...
    _createClass(ShadowDOM, [{
      ...
      value: function componentDidMount() {
        ...
        include.length === 0 ? this.setState({ root: root }) : (this.setState({ root: root, resolving: true }), this.attachIncludes(include).then(function () {
          _this3.setState({ resolving: false }, function () {
            if (_this3.props.onExternalFilesLoaded) {
              _this3.props.onExternalFilesLoaded();
            }
          });
        }));
      }
      ...
      value: function attachIncludes(include) {
        ...
        var groupedFiles = (0, _groupBy3.default)(function (file) {
          ...
          return { path: path, extension: getFileExtension(path) };
        }));
    ...
    onExternalFilesLoaded: _propTypes2.default.func
...
var _curry2 = __webpack_require__(1);
var _equals = __webpack_require__(52);
...
var _indexOf = __webpack_require__(55);
...
var _quote = __webpack_require__(61);
var _toISOString = __webpack_require__(62);
var keys = __webpack_require__(9);
...
var _has = __webpack_require__(3);
var _reduce = __webpack_require__(15);
var _xreduceBy = __webpack_require__(65);
...
var _complement = __webpack_require__(50);
var _curry2 = __webpack_require__(1);
